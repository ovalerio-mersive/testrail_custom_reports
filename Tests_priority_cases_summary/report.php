...
class Tests_priority_cases_summary_report_plugin extends Report_plugin
{
	private $_controls;
	private $_model;
	...
	public function __construct()
	{
		...
		$this->_model = new Tests_priority_cases_summary_summary_model();
		$this->_model->init();
...
class Tests_priority_cases_summary_summary_model extends BaseModel
{
